            ...
            >
              ...
              <div className="mt-5 sm:mt-6">
                <button
                  ...
                  className="inline-flex w-full justify-center rounded-md bg-primary px-3 py-2 t5 font-semibold text-white shadow-sm hover:bg-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-dark"
                >
                  Go back to home
                </button>
              </div>
